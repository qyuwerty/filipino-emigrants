...
// Add countries data record (supports single record or bulk import)
export const addCountriesData = async (country, year, count, yearData = null) => {
try {
...
// Add single year or bulk data
if (yearData && typeof yearData === 'object') {
// Bulk import - add all years
Object.entries(yearData).forEach(([yr, cnt]) => {
updatedData[yr.toString()] = cnt;
});
} else {
// Single year
updatedData[year.toString()] = count;
}
console.log("Converted array to object and added new data");
} else if (typeof dataField === 'object') {
// Object format: {"1981": 123, "1982": 456}
...
newData = {};
Object.entries(yearData).forEach(([yr, cnt]) => {
newData[yr.toString()] = cnt;
});
} else {
// Single year
newData = { [year.toString()]: count };
}

console.log("New data:", newData);

await setDoc(docRef, { "data": newData, "country": country });
